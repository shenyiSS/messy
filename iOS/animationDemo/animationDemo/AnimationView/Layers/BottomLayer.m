...
- (UIBezierPath *)beginPath {
    if (!_beginPath) {
        ...
        [_beginPath moveToPoint:CGPointMake(80, 80)];
        [_beginPath addLineToPoint:CGPointMake(120, 120)];
    }
    return _beginPath;
}
...
- (UIBezierPath *)endPath {
    if (!_endPath) {
        ...
        [_endPath moveToPoint:CGPointMake(80, 120)];
        [_endPath addLineToPoint:CGPointMake(120, 120)];
    }
    return _endPath;
}
